...
export async function GET(request) {
   try {
      ...
      // Totals for the currently selected period/filters (paid amount, quantity, outstanding balance).
      // All harvest KPIs are scoped to the selected year/period — unlike salaries/employees,
      // "Da pagare" here must NOT leak across years.
